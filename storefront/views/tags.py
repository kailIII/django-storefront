...
class TagList(ListView):
    ...
    """
    template_name = 'storefront/tag_list.html'
...
class BaseTagDetail(object):
    ...
    def get_queryset(self):
        ...
        if self.tag is None:
            raise Http404(_('No Tag matching "%s".') % self.kwargs['tag'])
...
class TagDetail( BaseTagDetail, BaseListView):
    """
